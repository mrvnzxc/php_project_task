...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['current_pass'], $_POST['new_pass'], $_POST['confirm_pass'])) {
        ...
        $sql = "SELECT pass FROM admin_tbl  LIMIT 1";
        ...
        if ($query && $row = $query->fetch_assoc()) {
            ...
            if ($current_pass === $passwordFromDB) {
                if ($new_pass === $confirm_pass) {
                    $sqlUpdate = "UPDATE admin_tbl SET pass='$new_pass' LIMIT 1";
        ...
        <div class="col-md-4">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <form id="changePasswordForm" action="changepass.php" method="POST">
