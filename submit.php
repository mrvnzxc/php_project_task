...
$sql = "SELECT finish_task_tbl.*, 
        ...
        WHERE finish_task_tbl.employee = '$employeeId'
          AND (finish_task_tbl.task LIKE '%$searchTerm%' OR finish_task_tbl.taskdescription LIKE '%$searchTerm%'
          OR finish_task_tbl.startdate LIKE '%$searchTerm%' OR finish_task_tbl.enddate LIKE '%$searchTerm%' OR finish_task_tbl.submitdate LIKE '%$searchTerm%'
          OR finish_task_tbl.remarks LIKE '%$searchTerm%')
            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-12 mt-n2">
                        <!-- TABLE STARTS HERE -->
                        <table class="table table-bordered table-striped table-light display mb-2" id = "submit" style = "width: 100%">
